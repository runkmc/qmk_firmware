...
#define SHCT 3 // my weird shortcuts
 ...
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * | Esc/Ctr|   A  |   S  |   D  |   F  |   G  |------|           |------|   H  |   J  |   K  |   L  |   ;  |   \    |
 * |--------+------+------+------+------+------|  {   |           |  }   |------+------+------+------+------+--------|
 * | LShi/( |   Z  |   X  |   C  |   V  |   B  |      |           |      |   N  |   M  |   ,  |   .  |   /  | RShi/) |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |Grv   |  '"  |AltShf| Alt  | Cmd  |                                       | Left |  Up  | Down | Right| ~L1  |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        | App  | LGui |       |  {   |   }  |  
 *                                 ,------|------|------|       |------+--------+------.
...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        KC_GRV,         KC_QUOT,      LALT(KC_LSFT),  KC_LALT,KC_LGUI,
                                              ALT_T(KC_APP),  KC_LGUI,
                                                              TG(MDIA),
                                               KC_SPC,MO(SHCT),MO(MDIA),
        // right hand
             KC_RCBR,     KC_6,   KC_7,   KC_8,   KC_9,   KC_0,         KC_BSPC,
 ...
 *                                 |      |      |      |       |      |      |Brwser|
 *                                 |      |      |------|       |------|      |Back  |
>>>>>>> 65f34e1318152685d9dc06d834dec42d1cfdd45a
 *                                 |      |      |      |       |      |      |      |
 *                                 `--------------------'       `--------------------'
 */
// MEDIA AND MOUSE
